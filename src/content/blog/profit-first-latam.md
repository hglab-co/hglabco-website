---
title: "Profit First para LATAM: cómo separar la plata de tu empresa de la tuya"
description: "Profit First aterrizado al contexto LATAM. Sistema de cuentas separadas para que el dueno deje de mezclar plata."
pubDate: 2026-05-15
category: "Operando con datos"
pillar: "Operando con datos"
excerpt: "Había meses en que la cuenta de la empresa y mi cuenta personal eran prácticamente la misma cosa. Necesitaba algo, lo sacaba de donde hubiera plata. Después lo repongo, me decía. No lo reponía. Ni una vez."
readingTime: "8 min"
tags: ["finanzas", "profit-first", "latam", "flujo-de-caja"]
draft: false
pdf: "https://hglab.co/recursos/profit-first-latam.pdf"
seoTitle: "Profit First para LATAM: separá la plata de tu empresa"
seoDescription: "Sistema Profit First adaptado para negocios LATAM. 4 cuentas, un sueldo definido y una regla que nunca rompes para operar con claridad financiera."
---
...
**Paso 1 — Abrí las cuentas (o subcuentas)**
Mínimo dos separadas: ingresos/operación del negocio y tu compensación personal. Si podés agregar ganancia e impuestos desde el inicio, mejor. Si no, empezá con dos.

**Paso 2 — Definí tu sueldo**
Ponelo en papel. ¿Cuánto te pagás mensualmente? Ese número es fijo. No retirés más sin registrarlo como dividendo.

**Paso 3 — Elegí tus porcentajes de inicio**
Conservadores está bien. El punto es que existan. 3% a ganancia, 15% a impuestos, el resto a operación y tu sueldo.

**Paso 4 — Poné una fecha cada diez días en el calendario**
Ese día revisás ingresos y distribuís. No es una sesión contable compleja — son 20 minutos con una planilla.

**Paso 5 — Nunca muevas plata entre cuentas fuera del ritual**
Esta regla cierra el sistema. Si hay urgencia, preguntate primero por qué existe y qué dice sobre tu flujo. La urgencia crónica es una señal, no una excepción.
